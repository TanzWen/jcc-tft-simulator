...
> **免责声明**
>
> 本项目为个人学习与研究用途的非官方工具，与腾讯公司、Riot Games 及《金铲铲之战》官方均无任何关联，也未获得其授权或认可。
>
> 项目本身不包含任何游戏数据或美术资源。所有英雄、羁绊、装备、强化符文数据及图片素材均由使用者自行从官网公开接口获取，其著作权归权利人所有，仅在本地保存与展示，不随仓库分发。
>
> 数据采集应遵守官网使用条款、Robots 协议及合理的访问频率，不绕过登录、验证码或其他访问限制。请勿将本项目用于商业用途或大规模抓取。
...
许可范围仅限本仓库自身的代码与文档，不包含运行时采集到的游戏数据与美术资源——后者的著作权归权利人所有，详见文首免责声明。
